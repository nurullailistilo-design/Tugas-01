...
while True:
    ...
    print("5. Ulang Tuple") # Catatan: Fungsi ulang_tuple tidak didefinisikan di gambar, kemungkinan merujuk pada loop menu ini
    ...
    if pilih == "1":
        ...
        # Jika fungsi ulang_tuple tidak ada, biasanya ini hanya untuk mereset tampilan menu
        print("Mengulang menu...")
    elif pilih == "6":
        ubah_tuple()
    elif pilih == "7":
